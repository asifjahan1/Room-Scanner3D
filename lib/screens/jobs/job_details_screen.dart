...
class JobDetailsScreen extends StatelessWidget {
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'JOB DETAILS',
            style: PerfektTheme.fontBold(17, color: PerfektTheme.textDark).copyWith(
              letterSpacing: 1.1,
            ),
          ),
          centerTitle: true,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            "Foundation Pour –\nSector C",
                            style: PerfektTheme.fontBold(24, color: PerfektTheme.textDark).copyWith(
                              height: 1.15,
                            ),
                          ),
                          ...
                          Row(
                            children: [
                              Icon(Icons.location_on_outlined, size: 15, color: PerfektTheme.textMedium),
                          ...
                          Row(
                            children: [
                              Icon(Icons.access_time_rounded, size: 15, color: PerfektTheme.textLight),
                              const SizedBox(width: 4),
                              Text(
                                "Start time 08:00 AM",
                                style: PerfektTheme.fontRegular(13, color: PerfektTheme.textLight),
                              ),
                            ],
                          ),
                        ],
                    ...
                    Container(
                      ...
                      child: const Center(
                        child: Icon(Icons.near_me_outlined, color: PerfektTheme.primaryBlue, size: 22),
                      ),
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Text(
                    "Zone A – Plot 8–24",
                    style: PerfektTheme.fontSemiBold(12, color: PerfektTheme.textMedium),
                  ),
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "Safety Alert",
                              style: PerfektTheme.fontBold(14, color: const Color(0xFF92400E)),
                            ),
                            const SizedBox(height: 2),
                            Text(
                              "High-Wind Advisory: Secure loose scaffolding prior to concrete operations.",
                              style: PerfektTheme.fontRegular(13, color: const Color(0xFFB45309)).copyWith(
                                height: 1.35,
                              ),
                            ),
                          ],
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.assignment_rounded, color: PerfektTheme.primaryBlue, size: 22),
                      ),
                      ...
                      const Icon(Icons.chevron_right_rounded, color: PerfektTheme.textLight),
                    ],
                  ),
                ),
                const SizedBox(height: 14),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.person_pin_circle_outlined, color: PerfektTheme.textDark, size: 22),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: Column(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            "Sector C-4 Active",
                            style: PerfektTheme.fontBold(13, color: Colors.white),
                          ),
                        ],
                      ),
                    ),
          ...
          child: SafeArea(
            child: Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  _buildNavItem(0, Icons.home_filled, Icons.home_outlined, 'Home', controller, false),
                  _buildNavItem(1, Icons.assignment_rounded, Icons.assignment_outlined, 'Task', controller, true),
                  _buildNavItem(2, Icons.handyman_rounded, Icons.handyman_outlined, 'Tools', controller, false),
                  _buildNavItem(3, Icons.chat_bubble_rounded, Icons.chat_bubble_outline_rounded, 'Message', controller, false),
                  _buildNavItem(4, Icons.menu_rounded, Icons.menu_rounded, 'More', controller, false),
                ],
              ),
            ),
          ),
  ...
  Widget _buildNavItem(int index, IconData activeIcon, IconData inactiveIcon, String label, DashboardController controller, bool isSelected) {
