            ...
            child: Column(
              ...
              children: [
                ...
                _buildNotificationCard(
                  ...
                  accentBorderColor: const Color(0xFF10B981), // Green Left Border
                ),
                const SizedBox(height: 16),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? PerfektTheme.primaryBlue : const Color(0xFFF1F5F9),
          borderRadius: BorderRadius.circular(20),
        ),
        child: Text(
          label,
          style: PerfektTheme.fontBold(13, color: isSelected ? Colors.white : PerfektTheme.textDark),
        ),
      ),
    );
  }
