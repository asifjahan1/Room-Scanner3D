...
class ProjectChatController extends GetxController {
  ...
  final RxList<ChatMessage> messages = <ChatMessage>[
    ChatMessage(
      ...
      role: "Electrician",
      time: "08:42 AM",
      content: "The wiring for the 4th floor lobby is completed. Ready for inspection tomorrow morning.",
    ),
    ChatMessage(
      sender: "James Miller",
      role: "Foreman",
      time: "09:15 AM",
      mention: "@Marcus ",
      content: "Great progress. Please double check the load distribution on panel B before the inspection. See attached reference from the site map.",
                    ...
                    if (index == 0) {
                      return Center(
                        child: Container(
                          ...
                          child: Text(
                            "TODAY",
                            style: PerfektTheme.fontBold(11, color: PerfektTheme.textMedium).copyWith(letterSpacing: 0.8),
                          ),
                        ),
                      );
                    }
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "${msg.sender} (${msg.role})",
              style: PerfektTheme.fontBold(12, color: msg.isHighlightBorder ? PerfektTheme.primaryBlue : PerfektTheme.textMedium),
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(20),
              border: Border.all(
                color: msg.isHighlightBorder ? PerfektTheme.primaryBlue : PerfektTheme.borderLight,
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: msg.content,
                        style: PerfektTheme.fontMedium(15, color: PerfektTheme.textDark).copyWith(height: 1.4),
                      ),
                    ],
                  ),
                ),
              ...
              Row(
                children: [
                  _buildIconButton(
                    ...
                    onTap: () => Get.snackbar("Camera", "Instant site capture ready.", snackPosition: SnackPosition.BOTTOM),
                  ),
                  const SizedBox(width: 10),
                  _buildIconButton(
                    icon: Icons.attach_file_rounded,
                    onTap: () => Get.snackbar("Attachments", "Cloud folder integration active.", snackPosition: SnackPosition.BOTTOM),
                  ),
                ],
              ),
              GestureDetector(
